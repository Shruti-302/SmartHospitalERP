...
<div class="ui container first">
  ...
  <div class="Box-body p-6">
        <article class="markdown-body entry-content" itemprop="text"><h1>Smart Hospital ERP</h1>
<p>This is a Smart Hospital ERP for managing, monitoring and controlling the system in a Hospital. 
